# Upload guide for The Plant Phenome Journal

The journal accepts LaTeX source, but ScholarOne does not accept a LaTeX file as the main document. Upload the files using these designations.
